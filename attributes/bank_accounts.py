class BankAccount:
    ...
    def deposit(self, amount):
        self.balance += amount
        print("Current Balance now", self.balance)
        return self
...
class User:		# declare a class and give it name User
    ...
    def make_withdraw(self, amount):
        ...
        print("Current Balance now", self.account.balance)
        return self
...
Steven = User("Steven", "fake@gmail.com", BankAccount(interest_rate=0.1, balance=0, account_type="checking"))
Joe = User("Joe", "joesEmail@gmail.com")
Peter = User("Peter", "dragon@gmail.com")

Steven.account.deposit(200).deposit(300).deposit(100).display_account_info(Steven.account.balance, "checking")
